...
progress (T-fix ⊢e) = step β-fix
progress (T-fold ⊢e) with progress ⊢e
...| step e⟶e' =  step (ξ-fold e⟶e')
...| done V-e   =  done (V-fold V-e)
progress (T-unfold ⊢e) with progress ⊢e
...| step e⟶e' =  step ( ξ-unfold e⟶e')
...| done (V-fold V-e) = step ( β-unfold ( V-fold V-e))
...
rename H (T-fold ⊢e) =  T-fold ( rename H ⊢e)
rename H (T-unfold ⊢e) =  T-unfold ( rename H ⊢e)
...
subst ⊢e' (T-fold ⊢e) =  T-fold ( subst ⊢e' ⊢e)
subst ⊢e' (T-unfold ⊢e) =  T-unfold (subst ⊢e' ⊢e)
...
preserve (T-fix ⊢e) β-fix =  subst ( T-fix ⊢e)  ⊢e
preserve (T-fold ⊢e) (ξ-fold e⟶e') = T-fold (preserve ⊢e e⟶e')
preserve (T-unfold ⊢e) (ξ-unfold e⟶e') =  T-unfold (preserve ⊢e e⟶e')
preserve (T-unfold (T-fold ⊢e)) (β-unfold V-e) = ⊢e
